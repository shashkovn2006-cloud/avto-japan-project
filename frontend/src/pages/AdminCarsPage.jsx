...
const AdminCarsPage = () => {
  ...
  const handleEdit = (car) => {
    ...
    setFormData({
      ...
      mileage: car.mileage || '',
      engine: car.engine || '',
      auctionGrade: car.auction_grade || '4.5',
      description: car.description || '',
      location: car.location || 'Tokyo, Japan',
      color: car.color || '',
    ...
    <div className="admin-cars-page">
      <div className="admin-header">
        <div className="admin-header-content">
          ...
          <p className="admin-subtitle">Добавление, редактирование и удаление автомобилей</p>
        </div>
        ...
        <div className="admin-modal">
          <div className="admin-modal-content">
            <div className="modal-header">
              <h2>{editingCar ? 'Редактировать автомобиль' : 'Новый автомобиль'}</h2>
