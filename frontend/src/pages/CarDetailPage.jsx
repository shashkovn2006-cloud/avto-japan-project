  ...
  if (!car) {
    return (
      <div className="app text-center">
        ...
        <button onClick={() => window.location.href = '/'} className="btn-primary">На главную</button>
      </div>
    );
  }
        ...
        <div className="car-detail-grid">
          ...
          <div className="car-gallery">
            <div className="main-image">
              {mainImage ? (
                <img src={mainImage} alt={car.title} style={{ width: '100%', borderRadius: '15px' }} />
              ) : (
              ...
              <span className="auction-badge-large">
                <i className="fas fa-gavel"></i> Аукцион: {car.auctionGrade || '4.5'}/5
              </span>
            </div>
            ...
            {isAdmin && (
              <>
                ...
                >
                  ...
                  {showUploader ? 'Скрыть загрузчик' : 'Загрузить фото (Админ)'}
                </button>
